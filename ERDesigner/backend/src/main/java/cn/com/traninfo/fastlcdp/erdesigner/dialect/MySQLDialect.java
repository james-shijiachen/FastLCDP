...
public class MySQLDialect extends AbstractDatabaseDialect {
     ...
     * @return 有效的存储引擎
     */
    private String getEffectiveEngine(TableDefinition table, DatabaseSchema databaseSchema) {
        // 优先使用表级别的engine定义
     ...
     * @return 有效的字符集
     */
    private String getEffectiveCharset(TableDefinition table, DatabaseSchema databaseSchema) {
        // 优先使用表级别的charset定义
