...
class XmlParserServiceTest {
    ...
    void testParseSimpleXml() throws JAXBException {
        ...
        assertEquals("UNIQUE", table.getIndexes().getFirst().getType().name());
    ...
    void testParseWithRelations() throws JAXBException {
        ...
        assertEquals("CASCADE", relation.getOnDelete().name());
        assertEquals("CASCADE", relation.getOnUpdate().name());
    }
