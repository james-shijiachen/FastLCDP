...
import com.fastlcp.service.XmlParserService;
...
public class SqlGeneratorService {
    ...
    public String generateCreateTableSql(TableDefinition table, DatabaseSchema databaseSchema) {
        ...
        if (dialect instanceof com.fastlcp.dialect.MySQLDialect) {
            com.fastlcp.dialect.MySQLDialect mysqlDialect = (com.fastlcp.dialect.MySQLDialect) dialect;
