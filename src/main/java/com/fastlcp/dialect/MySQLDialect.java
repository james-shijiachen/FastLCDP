...
public class MySQLDialect extends AbstractDatabaseDialect {
     ...
     * @return 创建表的SQL语句
     */
    public String generateCreateTableSql(TableDefinition table, com.fastlcp.model.DatabaseSchema databaseSchema) {
        StringBuilder sql = new StringBuilder();
     ...
     * @return 有效的存储引擎
     */
    private String getEffectiveEngine(TableDefinition table, com.fastlcp.model.DatabaseSchema databaseSchema) {
        // 优先使用表级别的engine定义
     ...
     * @return 有效的字符集
     */
    private String getEffectiveCharset(TableDefinition table, com.fastlcp.model.DatabaseSchema databaseSchema) {
        // 优先使用表级别的charset定义
