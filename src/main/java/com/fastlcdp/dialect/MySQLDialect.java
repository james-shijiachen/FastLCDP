package com.fastlcdp.dialect;

import com.fastlcdp.model.FieldDefinition;
import com.fastlcdp.model.IndexDefinition;
import com.fastlcdp.model.RelationDefinition;
...
public class MySQLDialect extends AbstractDatabaseDialect {
     ...
     * @return 创建表的SQL语句
     */
    public String generateCreateTableSql(TableDefinition table, com.fastlcdp.model.DatabaseSchema databaseSchema) {
        StringBuilder sql = new StringBuilder();
     ...
     * @return 有效的存储引擎
     */
    private String getEffectiveEngine(TableDefinition table, com.fastlcdp.model.DatabaseSchema databaseSchema) {
        // 优先使用表级别的engine定义
     ...
     * @return 有效的字符集
     */
    private String getEffectiveCharset(TableDefinition table, com.fastlcdp.model.DatabaseSchema databaseSchema) {
        // 优先使用表级别的charset定义
